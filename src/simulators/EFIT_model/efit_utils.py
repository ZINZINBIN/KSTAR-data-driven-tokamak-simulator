...
def plot_PINN_profile(model : FluxGenerator, data : Dict, device : str = "cpu", save_dir : str = "./result/", tag : str = "PINN", contour_regressor : Optional[ContourRegressor] = None):
...
def plot_PINN_comparison(model : FluxGenerator, psi:Union[torch.Tensor, np.ndarray], data : Dict, device : str = "cpu", save_dir : str = "./result/", tag : str = "PINN", contour_regressor : Optional[ContourRegressor] = None):
